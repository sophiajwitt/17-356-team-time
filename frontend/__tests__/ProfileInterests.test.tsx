...
const createTestComponent = (
  overrideProps: Partial<ResearchInterestProps> = {},
) => {
...
describe("ProfileInterests Component", () => {
  ...
  describe("Rendering", () => {
    test("renders correctly in non-editing mode with no interests", () => {
      createTestComponent();
      expect(
        screen.getByText("No research interests specified."),
      ).toBeDefined();
    });
    ...
    test("renders editing mode with input field", () => {
      ...
      expect(
        screen.getByPlaceholderText("Add interests (comma-separated)"),
      ).toBeDefined();
  ...
  describe("Interaction", () => {
    ...
    test("adds multiple interests via comma separation", () => {
      ...
      fireEvent.change(input, {
        target: { value: "Interest1, Interest2, Interest3" },
      });
      fireEvent.click(addButton);
  ...
  describe("Edge Cases", () => {
    ...
    test("trims whitespace from interests", () => {
      ...
      fireEvent.change(input, {
        target: { value: "  Interest1  ,  Interest2  " },
      });
      fireEvent.click(addButton);
